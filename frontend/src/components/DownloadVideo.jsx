      ...
      <div className={'dark:text-white w-full '+isAuth.contrast +' '+ isAuth.monoColor+' '+ isAuth.changeColor+" " +isAuth.saturate+ " "+isAuth.differentColor}>
          ...
          Upload video
            ...
            <Modal className={'dark:text-white '+isAuth.contrast +' '+ isAuth.monoColor+' '+ isAuth.changeColor+" " +isAuth.saturate+ " "+isAuth.differentColor} dismissible show={modalProps.openModal == 'dismissible'} size='4xl' onClose={() => modalProps.setOpenModal(undefined)}>
              ...
              {downloaded?
              <div className='bg-gray-50 dark:bg-gray-500 shadow-sm rounded-lg flex items-center justify-between p-[16px] text-2xl'>
              ...
              :<div class="flex items-center justify-center w-full text-2xl">
                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-max border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-100 dark:bg-gray-500 hover:bg-gray-100 ">
                    <div class="flex flex-col items-center justify-center py-12">
                        <p class="text-gray-500 font-normal  leading-tight"></p>
                        <p class="text-center dark:text-blue-300 text-blue-600  font-normal  leading-normal flex items-center gap-2">
